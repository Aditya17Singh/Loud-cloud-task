...
questSectionA01();//The new file is created as coursesFixed.csv
console.log("You see the list of course code and the duration of the section in days:", questSectionA02()); //you see in the terminal
questSectionB01();//The file is created as salesDataC.csv
questSectionC01(); //you can in the terminal
